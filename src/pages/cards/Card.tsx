...
const CardValueRenderer = {
  ...
  3: { template: "'a' 'b' 'c'" },
  4: { template: "'a b' 'c d'" },
  5: { template: "'a . b' '. c .' 'd . e'" },
  6: { template: "'a b' 'c d' 'e f'" },
  7: { template: "'a . b' '. c .' 'd . e' '. . .' 'f . g'" },
  8: { template: "'a b' 'c d' 'e f' 'g h'" },
  9: { template: "'a . b' '. c .' 'd . e' 'f . g' '. . .' 'h . i'" },
  10: { template: "'a . b' '. c .' 'd . e' 'f . g' '. h .' 'i . j'" },
