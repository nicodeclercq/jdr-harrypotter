  ...
  return (
    ...
    >
      <Accordion>
        {{
          header: (
            <div className="flex flex-row items-center p-2 space-x-2 border-b-gray-200">
              <Controller
                name="title"
                control={control}
          ...
          content: (
            <div className="w-full p-2 grid-cols-1 grid gap-2">
              <Controller
                name="description"
                control={control}
                rules={{ required: true, min: 0 }}
              ...
              <div className="justify-self-end">
                <Button type="secondary" onClick={() => removeNote(id)}>
                  Supprimer la note
                </Button>
              </div>
            </div>
