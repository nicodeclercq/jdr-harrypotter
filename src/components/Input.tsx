...
export function Input({
  ...
  const styles = {
    ...
    invalid:
      "ring-red-200 px-1 border border-red-500 rounded placeholder-red-600 text-red-900 bg-red-200 bg-opacity-50",
    ...
    >
      <input
        ...
        className={`w-full focus:ring-4 h-7 ${
          errors ? styles.invalid : disabled ? styles.disabled : styles[theme]
        }`}
        onChange={(e) => {
