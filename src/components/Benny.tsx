...
export function Benny({position, onDragStop, onUse}: Props){
  ...
  return (
    <Draggable
      ...
      style={{width: '15vmin', height: '15vmin', border: '0.0625vmin solid white', fontSize:'10vmin', boxShadow: 'rgb(219, 219, 219) 1px 1px, rgb(190, 190, 190) 2px 2px, rgba(0, 0, 0, 0.2) 0.25rem 0.25rem 0.25rem'}}
