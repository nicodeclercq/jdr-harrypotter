...
export const speechSpecificity = [
  "Bégaie",
  "Zozote",
  "Hache ses phrases",
  "\"... voila!\"",
  "\"Donc! ...\"",
  "\"En fait ...\"",
  "Fait de longues pauses dans ses phrases",
  "Voix qui déraille",
  "Voix aigüe",
  "Voix chevrotante",
  "Répond aux questions par d'autres questions",
  "\"Ça me rappel quand...\"",
  "Remet tout en question",
  "S'approprie toutes les décisions",
  "Voix grâve",
  "Se racle la gorge avant de parler",
  "Ailleurs",
  "Sifflote",
  "Intonation forte en fin de phrase",
  "Intonation faible en fin de phrase",
  "Mache ses mots",
  "\"Écoutez...\"",
  "Oublie tout au fur et à mesure",
  "Ne finit pas ses phrases",
  "",
  "",
  "",
  "",
