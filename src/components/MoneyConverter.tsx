...
const toEuro = (galion: number | undefined, mornille: number | undefined, noise: number | undefined) => {
  return (!!galion ? galion : 0) * CurrencyDivisions.gallion / EURO_TO_NOISE_FACTOR
...
const toNoise = (galion: number | undefined, mornille: number | undefined, noise: number | undefined) => {
  return (!!galion ? galion : 0) * CurrencyDivisions.gallion
...
function MoneySubstractor(){
  ...
  useEffect(() => {
    setDivision(
      getDivisions(
        toNoise(galion1, mornille1, noise1) - toNoise(galion2, mornille2, noise2)
      )
    );
  ...
  <div>
    <div className="flex flex-col justify-end px-2 py-1 space-x-2 space-y-2">
      <div className="flex justify-end space-x-2">
        <span>
          <Input theme="neutral" width="7ch" onChange={setGalion1} type="number" />&nbsp;
          <span style={{color: 'goldenrod'}}><Icon name="COIN" /></span>
        </span>
        <span>
          <Input theme="neutral" width="7ch" onChange={setMornille1} type="number" />&nbsp;
          <span style={{color: 'silver'}}><Icon name="COIN" /></span>
        </span>
        <span>
          <Input theme="neutral" width="7ch" onChange={setNoise1} type="number" />&nbsp;
      ...
      <div className="flex justify-end space-x-2">
        <span>-</span>
        <span>
          <Input theme="neutral" width="7ch" onChange={setGalion2} type="number" />&nbsp;
          <span style={{color: 'goldenrod'}}><Icon name="COIN" /></span>
        </span>
        <span>
          <Input theme="neutral" width="7ch" onChange={setMornille2} type="number" />&nbsp;
          <span style={{color: 'silver'}}><Icon name="COIN" /></span>
        </span>
        <span>
          <Input theme="neutral" width="7ch" onChange={setNoise2} type="number" />&nbsp;
          <span style={{color: '#b87333'}}><Icon name="COIN" /></span>
        </span>
      </div>
    </div>
